...
// ゾーンB: 杁ヶ池公園（北=記念館、左=文化の家。リニモは画面右を縦走）
// ~=杁ヶ池, a=公園の看板, N=御旗山, e=杁ヶ池公園駅, W/^=住宅, r=道路・軌道
const ZONEB = [
  'TTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTrrrTT',
  'T..................................rrr.T',
  'T..................................rrr.T',
  ...
  'T................T.................rrr.T',
  'T..................................rrr.T',
  'rrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrr.T',
  'rrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrr.T',
  'T..................................rrr.T',
  'T..................................rrr.T',
  'T...............................eeerrr.T',
...
// ゾーンC: 市役所（北=色金山、右=記念館、南=文化の家）
// 2=市役所, h=愛知医大病院, Y/4=一蘭, M=武蔵塚, r=県道57号
const ZONEC = [
  'TTTTTTTTTTTTTTTTTTT,,,TTTTTTTTTTTTTTTTTT',
  'T..................,,,.................T',
  'T..^^^^^^^.........,,,.................T',
  'T..WWWWWWW.........,,,....^^^^^^^^.....T',
  'T..WWWWWWW.........,,,....WWWWWWWW.....T',
  'T..WWWWWWW.........,,,....WWWWWWWW.....T',
  'T..WWWhWWW.........,,,....WWWWWWWW.....T',
  'T..................,,,....WWWWWWWW.....T',
  'T..................,,,....WWW22WWW.....T',
  'T..................,,,.................T',
  'T..................,,,.................T',
...
// ゾーンD: 文化の家（北=市役所、右=杁ヶ池）
// F/^/1=文化の家, L/2=図書館, b/a=桧ヶ根公園, e=はなみずき通駅
const ZONED = [
  'TTTTTTTTTTTTTTTTTTT,,,TTTTTTTTTTTTTTTTTT',
  'T..................,,,.................T',
  'T..................,,,.................T',
...
// ゾーンH: 色金山（右=芸大、南=市役所）
// J=岩山/寺, R=床机石, 1=茶室, o=安昌寺, x=射的
const ZONEH = [
  'TTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTT',
  'T......................................T',
  'T......................................T',
  'T...........JJJJJJJJJJ.................T',
  'T..JJJJJJ...JJJJJJJJJJ.................T',
  'T..JJJJJJ...JJJJRJJJJJ.................T',
  'T..JJJJJJ...JJJJ,JJJJJ.................T',
  'T..JJJoJJ...JJJJ,JJJJJ.................T',
  'T...........JJJJ,JJJJJ...^^^^^.........T',
  'T...........JJJJ,JJJJJ...JJJJJ.........T',
  'T...........JJJJ,JJJJJ...JJ1JJ.........T',
  'T...............,......................T',
  'T...............,......................T',
  'T...............,..rrrrrrrrrrrrxrrrrrrrr',
  'T...............,..rrrrrrrrrrrrrrrrrrrrr',
  'T..................,,,.................T',
  'T..................,,,.................T',
  'T....T.............,,,.................T',
...
// リニモ駅・ホーム階（島式1面2線・全駅共通。r=線路、G=藤が丘方面、e=八草方面、
...
// 色金山ダンジョン・登山道（つづら折り。v=下山口(zoneHへ), 5=山頂への石段, J=岩壁）
const IROGANE1 = [
  'TTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTT',
  'T......................................T',
  'T.......T...........8.......T..........T',
...
const MAP_DEFS = {
  ...
  zoneA: {
    ...
    edges: {
      west: { map: 'zoneC', spawn: { col: 38, row: 14 } },
      north: { map: 'zoneF', spawn: { col: 36, row: 26 } },
      south: { map: 'zoneB', spawn: { col: 36, row: 1 } },
    },
  ...
  zoneB: {
    ...
    edges: {
      north: { map: 'zoneA', spawn: { col: 36, row: 30 } },
      west: { map: 'zoneD', spawn: { col: 38, row: 14 } },
    },
  ...
  zoneC: {
    ...
    solid: ['T', 'M', 'W', '^', '2', 'Y', '4', 'h'],
    npcs: {},
    acts: { 2: 'cityhall', 4: 'ramen', M: 'site_musashi', h: 'flavor_aidai' },
    edges: {
      east: { map: 'zoneA', spawn: { col: 1, row: 9 } },
      north: { map: 'zoneH', spawn: { col: 20, row: 26 } },
      south: { map: 'zoneD', spawn: { col: 20, row: 1 } },
    },
  ...
  zoneD: {
    ...
    solid: ['T', 'F', '^', 'L', '1', '2', 'b', 'e'],
    npcs: {},
    acts: { 1: 'bunka_in', 2: 'library', a: 'higane', e: 'station' },
    edges: {
      north: { map: 'zoneC', spawn: { col: 20, row: 26 } },
      east: { map: 'zoneB', spawn: { col: 1, row: 14 } },
    },
    encounter: { rate: 0.04, afterUnlock: true },
  },
  zoneE: {
    ...
    edges: { south: { map: 'zoneG', spawn: { col: 36, row: 1 } } },
    encounter: null,
  },
  zoneF: {
    ...
    edges: {
      north: { map: 'zoneG', spawn: { col: 36, row: 26 } },
      west: { map: 'zoneH', spawn: { col: 38, row: 14 } },
      south: { map: 'zoneA', spawn: { col: 36, row: 1 } },
    },
  ...
  zoneG: {
    ...
    solid: ['T', 'W', '^', 'f', 'e'],
    npcs: {},
    acts: { f: 'flavor_ikea', e: 'station' },
    edges: {
      north: { map: 'zoneE', spawn: { col: 36, row: 26 } },
      south: { map: 'zoneF', spawn: { col: 36, row: 1 } },
      west: { map: 'zoneI', spawn: { col: 38, row: 14 } },
    },
    encounter: { rate: 0.05, afterUnlock: true },
  },
  zoneH: {
    rows: ZONEH, kind: 'outdoor', tileset: 'outdoor', playerFloor: '.',
    solid: ['T', 'R', 'J', '^', '1', 'o', 'x'],
    npcs: {},
    acts: { R: 'irogane_in', 1: 'tearoom', o: 'site_ansho', x: 'shateki' },
    edges: {
      east: { map: 'zoneF', spawn: { col: 1, row: 14 } },
      south: { map: 'zoneC', spawn: { col: 20, row: 1 } },
    },
    encounter: { rate: 0.045, afterUnlock: true },
  },
  zoneI: {
    rows: ZONEI, kind: 'outdoor', tileset: 'outdoor', playerFloor: '.',
    solid: ['T', 'K', '^', '3'],
    npcs: {},
    acts: { 3: 'kodomo' },
    edges: { east: { map: 'zoneG', spawn: { col: 1, row: 14 } } },
    encounter: { rate: 0.05, afterUnlock: true },
  },
  aeon_in: {
  ...
  station_home: {
    ...
    solid: ['#', 'r', 'G', 'e', 'p', 'D'],
    npcs: {},
    acts: { D: 'station_exit', G: 'station_board_fujigaoka', e: 'station_board_yakusa', p: 'station_sign' },
    encounter: null,
  },
  irogane1: {
...
const HD_BLD_DEF = {
  ...
  zoneB: [{ key: 'station', c0: 32, r0: 17, w: 3, h: 3 }],
  zoneC: [
    { key: 'aidai', c0: 3, r0: 2, w: 7, h: 5 },
    { key: 'cityhall', c0: 26, r0: 3, w: 8, h: 6 },
    { key: 'ramen', c0: 25, r0: 18, w: 5, h: 3 },
  ],
  zoneD: [
    { key: 'bunka', c0: 12, r0: 6, w: 16, h: 7 },
    { key: 'library', c0: 31, r0: 16, w: 7, h: 4 },
    { key: 'station', c0: 27, r0: 21, w: 3, h: 3 },
  ],
  zoneE: [
    { key: 'ferris', c0: 26, r0: 3, w: 4, h: 4 },
    { key: 'station', c0: 32, r0: 18, w: 3, h: 3 },
  ],
  zoneF: [
    { key: 'station', c0: 32, r0: 17, w: 3, h: 3 },
    { key: 'toyota', c0: 4, r0: 17, w: 9, h: 5 },
    { key: 'geidai', c0: 22, r0: 3, w: 10, h: 5 },
  ],
  zoneG: [
    { key: 'station', c0: 32, r0: 17, w: 3, h: 3 },
    { key: 'ikea', c0: 4, r0: 17, w: 10, h: 6 },
  ],
  zoneH: [
    { key: 'temple', c0: 3, r0: 4, w: 6, h: 4 },
    { key: 'tearoom', c0: 25, r0: 8, w: 5, h: 3 },
  ],
  zoneI: [{ key: 'kodomo', c0: 12, r0: 5, w: 7, h: 4 }],
...
const LINIMO_STATIONS = [
  { id: 'fujigaoka', name: '藤が丘', terminalOnly: true },
  { id: 'hanamizuki', name: 'はなみずき通', map: 'zoneD', col: 28, row: 20 },
  { id: 'iriga', name: '杁ヶ池公園', map: 'zoneB', col: 33, row: 20 },
  { id: 'kosenjo', name: '長久手古戦場', map: 'zoneA', col: 33, row: 9 },
  { id: 'geidai', name: '芸大通', map: 'zoneF', col: 33, row: 20 },
  { id: 'koennishi', name: '公園西', map: 'zoneG', col: 33, row: 20 },
  { id: 'expo', name: '愛・地球博記念公園', map: 'zoneE', col: 33, row: 21 },
  { id: 'yakusa', name: '八草', terminalOnly: true },
];
// 高架軌道: はなみずき通だけ横方向。他の屋外駅は現地配置に合わせて縦方向。
const LINIMO_TRACK = {
  zoneD: { c0: 24, c1: 38, row: 24.5 },
  zoneB: { orientation: 'vertical', col: 36, r0: 0, r1: 27 },
  zoneA: { orientation: 'vertical', col: 36, r0: 0, r1: 31 },
  zoneF: { orientation: 'vertical', col: 36, r0: 0, r1: 27 },
  zoneG: { orientation: 'vertical', col: 36, r0: 0, r1: 27 },
  zoneE: { orientation: 'vertical', col: 36, r0: 0, r1: 27 },
};
...
const ENCOUNTER_TABLES = {
  ...
  zoneH:   [{ id: 'sabiyari', w: 40 }, { id: 'chagama', w: 40 }, { id: 'hagure', w: 20, mate: 'monomi' }],
  zoneI:   [{ id: 'tagakashi', w: 55 }, { id: 'chigaeru', w: 25 }, { id: 'mizuchi', w: 20 }],
...
const MOB_DEFS = [
  ...
  // --- ゾーンH: 岩作・色金山 ---
  { id: 'mob_nofu', kind: 'civ3', map: 'zoneH',
  ...
  { id: 'mob_kuruma', kind: 'civ1', map: 'zoneF',
    spots: { quest: { col: 14, row: 20 }, post: { col: 14, row: 20 } } },
  // --- ゾーンG: 公園西 ---
  { id: 'mob_kaimono', kind: 'civ2', map: 'zoneG',
    spots: { quest: { col: 15, row: 20 }, post: { col: 15, row: 20 } } },
  // --- ゾーンI: 平成こども塾 ---
  { id: 'mob_yamakid', kind: 'civ4', map: 'zoneI',
    spots: { quest: { col: 24, row: 10 }, post: { col: 24, row: 10 } } },
];
